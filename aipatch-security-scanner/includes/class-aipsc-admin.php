...
class AIPSC_Admin {
    ...
    public function enqueue_assets( $hook ) {
        ...
        wp_localize_script( 'aipatch-admin', 'aipatchAdmin', array(
            ...
            'i18n'      => array(
                ...
                'scanComplete'      => __( 'Scan complete!', 'aipatch-security-scanner' ),
                ...
                'lastScan'          => __( 'Last scan', 'aipatch-security-scanner' ),
                'noScanYet'         => __( 'No scan yet. Run your first scan.', 'aipatch-security-scanner' ),
                'nextScan'          => __( 'Next automatic scan', 'aipatch-security-scanner' ),
                'computing'         => __( 'Computing security score...', 'aipatch-security-scanner' ),
                'scanFailed'        => __( 'Scan failed. Please try again.', 'aipatch-security-scanner' ),
                'initializing'      => __( 'Initializing scan...', 'aipatch-security-scanner' ),
                'activePlugins'     => __( 'Active Plugins', 'aipatch-security-scanner' ),
                'pluginsOutdated'   => __( 'Plugins Outdated', 'aipatch-security-scanner' ),
                'inactivePlugins'   => __( 'Inactive Plugins', 'aipatch-security-scanner' ),
                'themesOutdated'    => __( 'Themes Outdated', 'aipatch-security-scanner' ),
                'wpVersion'         => __( 'WordPress Version', 'aipatch-security-scanner' ),
                'adminUsers'        => __( 'Admin Users', 'aipatch-security-scanner' ),
                'dbPrefix'          => __( 'DB Prefix', 'aipatch-security-scanner' ),
                'xmlrpc'            => __( 'XML-RPC', 'aipatch-security-scanner' ),
                'restApi'           => __( 'REST API', 'aipatch-security-scanner' ),
                'debugMode'         => __( 'Debug Mode', 'aipatch-security-scanner' ),
                'fileEditor'        => __( 'File Editor', 'aipatch-security-scanner' ),
                'loginProtection'   => __( 'Login Protection', 'aipatch-security-scanner' ),
                'coreAutoUpdates'   => __( 'Core Auto-Updates', 'aipatch-security-scanner' ),
                'securityChecks'    => __( 'Security Checks', 'aipatch-security-scanner' ),
                'disabled'          => __( 'Disabled', 'aipatch-security-scanner' ),
                'enabled'           => __( 'Enabled', 'aipatch-security-scanner' ),
                'default_'          => __( 'Default', 'aipatch-security-scanner' ),
                'custom'            => __( 'Custom', 'aipatch-security-scanner' ),
                'restricted'        => __( 'Restricted', 'aipatch-security-scanner' ),
                'public_'           => __( 'Public', 'aipatch-security-scanner' ),
                'on'                => __( 'On', 'aipatch-security-scanner' ),
                'off'               => __( 'Off', 'aipatch-security-scanner' ),
                'active'            => __( 'Active', 'aipatch-security-scanner' ),
                'protected_'        => __( 'Protected', 'aipatch-security-scanner' ),
                'open'              => __( 'Open', 'aipatch-security-scanner' ),
                'checks'            => __( 'checks', 'aipatch-security-scanner' ),
                'issues'            => __( 'issues', 'aipatch-security-scanner' ),
                ...
                'stepConfig'        => __( 'Auditing Configuration...', 'aipatch-security-scanner' ),
                'stepServer'        => __( 'Checking Server Security...', 'aipatch-security-scanner' ),
                'stepSurface'       => __( 'Scanning Attack Surface...', 'aipatch-security-scanner' ),
                'stepFiles'         => __( 'Analyzing File System...', 'aipatch-security-scanner' ),
            ),
        ) );
    }
    ...
    public function render_dashboard() {
        ...
        // No data computation here — dashboard loads via AJAX for instant rendering.
